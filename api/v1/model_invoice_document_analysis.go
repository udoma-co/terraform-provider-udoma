...
func NewInvoiceDocumentAnalysis(number string, issueDate int64, vendor NullableContactData, id string, attachmentRef string, pages []int32, confidence float32) *InvoiceDocumentAnalysis {
