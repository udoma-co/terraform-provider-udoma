...
// checks if the QueryCaseTemplatesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryCaseTemplatesRequest{}
...
func (o QueryCaseTemplatesRequest) ToMap() (map[string]interface{}, error) {
