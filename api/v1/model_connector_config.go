...
func NewConnectorConfig(connectorId string, name string, enabled bool, pingTime string, syncTime string, createdAt int64, updatedAt int64) *ConnectorConfig {
