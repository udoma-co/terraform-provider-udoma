...
func NewCreateOrUpdateConnectorQueryRequest(name string, connectorRef string, enabled bool, entityLimit int32, statement string, processScript string) *CreateOrUpdateConnectorQueryRequest {
