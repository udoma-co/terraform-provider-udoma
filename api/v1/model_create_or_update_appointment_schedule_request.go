...
func (o *CreateOrUpdateAppointmentScheduleRequest) GetBookingBuffer() int32 {
...
// and a boolean to check if the value has been set.
func (o *CreateOrUpdateAppointmentScheduleRequest) GetBookingBufferOk() (*int32, bool) {
	if o == nil || IsNil(o.BookingBuffer) {
		return nil, false
	}
...
func (o *CreateOrUpdateAppointmentScheduleRequest) HasBookingBuffer() bool {
	if o != nil && !IsNil(o.BookingBuffer) {
		return true
	}
...
func (o *CreateOrUpdateAppointmentScheduleRequest) SetBookingBuffer(v int32) {
	o.BookingBuffer = &v
}
