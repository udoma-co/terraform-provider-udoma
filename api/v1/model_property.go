...
func (o *Property) GetManagementTypes() []PropertyManagementTypeEnum {
...
// and a boolean to check if the value has been set.
func (o *Property) GetManagementTypesOk() ([]PropertyManagementTypeEnum, bool) {
	if o == nil || IsNil(o.ManagementTypes) {
		return nil, false
	}
...
func (o *Property) HasManagementTypes() bool {
	if o != nil && !IsNil(o.ManagementTypes) {
		return true
	}
...
func (o *Property) SetManagementTypes(v []PropertyManagementTypeEnum) {
	o.ManagementTypes = v
}

// GetOwnerRefs returns the OwnerRefs field value if set, zero value otherwise.
func (o *Property) GetOwnerRefs() []string {
...
// and a boolean to check if the value has been set.
func (o *Property) GetOwnerRefsOk() ([]string, bool) {
	if o == nil || IsNil(o.OwnerRefs) {
		return nil, false
	}
...
func (o *Property) HasOwnerRefs() bool {
	if o != nil && !IsNil(o.OwnerRefs) {
		return true
	}
...
func (o *Property) SetOwnerRefs(v []string) {
	o.OwnerRefs = v
}
