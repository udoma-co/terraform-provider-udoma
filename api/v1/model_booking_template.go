...
func (o *BookingTemplate) GetIsCatalogItem() bool {
...
// and a boolean to check if the value has been set.
func (o *BookingTemplate) GetIsCatalogItemOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCatalogItem) {
		return nil, false
	}
...
func (o *BookingTemplate) HasIsCatalogItem() bool {
	if o != nil && !IsNil(o.IsCatalogItem) {
		return true
	}
...
func (o *BookingTemplate) SetIsCatalogItem(v bool) {
	o.IsCatalogItem = &v
}
