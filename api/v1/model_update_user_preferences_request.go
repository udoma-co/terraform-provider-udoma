...
func (o *UpdateUserPreferencesRequest) GetNotifyOnNewDataCapture() []NotificationType {
...
// and a boolean to check if the value has been set.
func (o *UpdateUserPreferencesRequest) GetNotifyOnNewDataCaptureOk() ([]NotificationType, bool) {
	if o == nil || o.NotifyOnNewDataCapture == nil {
		return nil, false
	}
...
func (o *UpdateUserPreferencesRequest) HasNotifyOnNewDataCapture() bool {
	if o != nil && o.NotifyOnNewDataCapture != nil {
		return true
	}
...
func (o *UpdateUserPreferencesRequest) SetNotifyOnNewDataCapture(v []NotificationType) {
