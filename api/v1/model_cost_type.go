...
func (o *CostType) GetIsCatalogItem() bool {
...
// and a boolean to check if the value has been set.
func (o *CostType) GetIsCatalogItemOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCatalogItem) {
		return nil, false
	}
...
func (o *CostType) HasIsCatalogItem() bool {
	if o != nil && !IsNil(o.IsCatalogItem) {
		return true
	}
...
func (o *CostType) SetIsCatalogItem(v bool) {
	o.IsCatalogItem = &v
}
