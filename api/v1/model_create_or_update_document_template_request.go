...
func NewCreateOrUpdateDocumentTemplateRequest(name string, options DocumentTemplateOptions, content string, inputs NullableCustomForm) *CreateOrUpdateDocumentTemplateRequest {
