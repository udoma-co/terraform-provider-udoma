...
// WorkflowExecution an execution of a workflow
type WorkflowExecution struct {
	...
	// the ID of the step that is the current step of the workflow execution
	CurrentStep *string `json:"current_step,omitempty"`
	// the name of the step that is the current step of the workflow execution
