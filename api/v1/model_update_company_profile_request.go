...
func (o *UpdateCompanyProfileRequest) GetSignatureText() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateCompanyProfileRequest) GetSignatureTextOk() (*string, bool) {
	if o == nil || IsNil(o.SignatureText) {
		return nil, false
	}
...
func (o *UpdateCompanyProfileRequest) HasSignatureText() bool {
	if o != nil && !IsNil(o.SignatureText) {
		return true
	}
...
func (o *UpdateCompanyProfileRequest) SetSignatureText(v string) {
	o.SignatureText = &v
}
