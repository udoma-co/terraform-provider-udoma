...
*DefaultAPI* | [**DeleteConnectorConfig**](docs/DefaultAPI.md#deleteconnectorconfig) | **Delete** /connector/{connectorID}/config | Delete the connector configuration
...
*DefaultAPI* | [**GetConnectorConfig**](docs/DefaultAPI.md#getconnectorconfig) | **Get** /connector/{connectorID}/config | Get the connector configuration for the current account
...
*DefaultAPI* | [**GetConnectorQueries**](docs/DefaultAPI.md#getconnectorqueries) | **Get** /connector/config/{connectorID}/queries | Get the queries that belong to the config.
...
*DefaultAPI* | [**UpdateConnectorConfig**](docs/DefaultAPI.md#updateconnectorconfig) | **Post** /connector/{connectorID}/config | Update the connector configuration
*DefaultAPI* | [**UpdateConnectorQuery**](docs/DefaultAPI.md#updateconnectorquery) | **Post** /connector/{queryID}/query | Update the connector Query
...
*DefaultAPI* | [**UpdateServiceProvider**](docs/DefaultAPI.md#updateserviceprovider) | **Put** /service-provider/{serviceProviderId} | Update the attributes of the service provide
...
## Documentation For Models
 ...
 - [CreateOrUpdateConnectorConfigRequest](docs/CreateOrUpdateConnectorConfigRequest.md)
