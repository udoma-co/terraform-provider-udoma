...
func (o *WorkflowDefinition) GetStepGroups() []WorkflowStepGroup {
...
// and a boolean to check if the value has been set.
func (o *WorkflowDefinition) GetStepGroupsOk() ([]WorkflowStepGroup, bool) {
	if o == nil || IsNil(o.StepGroups) {
		return nil, false
	}
...
func (o *WorkflowDefinition) HasStepGroups() bool {
	if o != nil && !IsNil(o.StepGroups) {
		return true
	}
...
func (o *WorkflowDefinition) SetStepGroups(v []WorkflowStepGroup) {
	o.StepGroups = v
}
...
func (o *WorkflowDefinition) GetIsCatalogItem() bool {
...
// and a boolean to check if the value has been set.
func (o *WorkflowDefinition) GetIsCatalogItemOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCatalogItem) {
		return nil, false
	}
...
func (o *WorkflowDefinition) HasIsCatalogItem() bool {
	if o != nil && !IsNil(o.IsCatalogItem) {
		return true
	}
...
func (o *WorkflowDefinition) SetIsCatalogItem(v bool) {
	o.IsCatalogItem = &v
}
