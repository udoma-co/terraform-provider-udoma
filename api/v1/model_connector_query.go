...
type ConnectorQuery struct {
	...
	// The ID of the connector this query belongs to.
...
func NewConnectorQuery(id string, name string, connectorRef string, enabled bool, entityLimit int32, statement string, processScript string, updatedLast int64, createdAt int64, updatedAt int64) *ConnectorQuery {
	this := ConnectorQuery{}
	this.Id = id
	this.Name = name
