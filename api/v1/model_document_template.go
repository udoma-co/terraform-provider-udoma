...
func (o *DocumentTemplate) GetSignatures() DocumentTemplateSignatureConfiguration {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DocumentTemplate) GetSignaturesOk() (*DocumentTemplateSignatureConfiguration, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DocumentTemplate) SetSignatures(v DocumentTemplateSignatureConfiguration) {
	o.Signatures.Set(&v)
}
...
func (o *DocumentTemplate) GetIsCatalogItem() bool {
...
// and a boolean to check if the value has been set.
func (o *DocumentTemplate) GetIsCatalogItemOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCatalogItem) {
		return nil, false
	}
...
func (o *DocumentTemplate) HasIsCatalogItem() bool {
	if o != nil && !IsNil(o.IsCatalogItem) {
		return true
	}
...
func (o *DocumentTemplate) SetIsCatalogItem(v bool) {
	o.IsCatalogItem = &v
}
