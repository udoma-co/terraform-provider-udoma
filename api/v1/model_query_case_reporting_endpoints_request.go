...
// checks if the QueryCaseReportingEndpointsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryCaseReportingEndpointsRequest{}
...
func (o QueryCaseReportingEndpointsRequest) ToMap() (map[string]interface{}, error) {
